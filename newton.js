var newton = {
  ...
  init: function(that){
    ...
    that.newton_left_thigh.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_right_thigh.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_left_leg.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_right_leg.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_trousers.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_torso.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_head.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_eyes.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_mouth.body.data.gravityScale = utilities.randomizer(0.1, 1);
    ...
    that.newton_hair.body.data.gravityScale = utilities.randomizer(0.1, 1);
